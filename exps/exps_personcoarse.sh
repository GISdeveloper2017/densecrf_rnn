...
python train_gby.py -m fcn_RESNET50_8s_crfrnn -is 224 -ds personcoarse -e $num_ep -bs 1
python train_gby.py -m fcn_RESNET50_8s_crfrnnSP -is 224 -ds personcoarse -e $num_ep -bs 1
python train_gby.py -m fcn_RESNET50_8s_crfrnnSPIO -is 224 -ds personcoarse -e $num_ep -bs 1
python train_gby.py -m fcn_RESNET50_8s_crfrnnSPAT -is 224 -ds personcoarse -e $num_ep -bs 1
python train_gby.py -m fcn_RESNET50_8s_crfrnnSPIOAT -is 224 -ds personcoarse -e $num_ep -bs 1
