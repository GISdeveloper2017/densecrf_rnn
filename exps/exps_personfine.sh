...
# running experiments for the personfine:
num_ep=1
echo "num epochs is $num_ep"
#python train_gby_pf.py -m fcn_RESNET50_8s_crfrnn -is 224 -ds personfine -e $num_ep -bs 1
python train_gby_pf.py -m fcn_RESNET50_8s_crfrnnSP -is 224 -ds personfine -e $num_ep -bs 1
python train_gby_pf.py -m fcn_RESNET50_8s_crfrnnSPIO -is 224 -ds personfine -e $num_ep -bs 1
python train_gby_pf.py -m fcn_RESNET50_8s_crfrnnSPAT -is 224 -ds personfine -e $num_ep -bs 1
python train_gby_pf.py -m fcn_RESNET50_8s_crfrnnSPIOAT -is 224 -ds personfine -e $num_ep -bs 1
