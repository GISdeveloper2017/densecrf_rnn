...
from models_gby_hf import load_model_gby
...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint(RES_DIR+"horse_fine_sp_weights.{epoch:02d}-{val_loss:.2f}", save_weights_only=True,verbose=1, period=1)
    cb_list = [checkpoint]
