...
if __name__ == '__main__':
    ...
    config.gpu_options.visible_device_list = "3" # default: "2"
    ...
    checkpoint = ModelCheckpoint(RES_DIR+"person_coarse_weights_start500.{epoch:02d}-{val_loss:.2f}", save_weights_only=True,verbose=1, period=50)
    cb_list = [checkpoint]
    ...
    if not data_augmentation_flag:
        ...
        hist1 = model.fit(ds.X_train, ds.y_train,
                          ...
                          batch_size=batch_size, callbacks=cb_list, epochs=num_epochs, verbose=verbose_mode)
    else:
        ...
        hist1 = model.fit_generator(generator=ds.datagen_train,
                                    ...
                                    epochs=num_epochs,
                                    callbacks= cb_list, verbose=verbose_mode)
