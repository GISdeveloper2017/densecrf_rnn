...
from models_gby_pf import load_model_gby
...
if __name__ == '__main__':
    ...
    checkpoint = ModelCheckpoint(RES_DIR+"person_fine_weights.{epoch:02d}-{val_loss:.2f}", save_weights_only=True,verbose=1, period=1)
    cb_list = [checkpoint]
    ...
    # SAVE model:
    # ===============
    save_by_name = RES_DIR + args.dataset + '_weights_650_' + model.name + '_' + str(num_epochs) + 'ep'
