...
#saved_model_path = '/storage/cfmata/deeplab/crf_rnn/crfasrnn_keras/results/person_coarse/person_coarse_weights.500-0.47'
...
#
#saved_model_path = '/storage/cfmata/deeplab/crf_rnn/crfasrnn_keras/results/horse_fine/horse_fine_weights.500-0.53'
saved_model_path = '/storage/gby/semseg/horsefine_weights_fcn_RESNET50_8s_1000ep'
#
#saved_model_path = ''
...
def fcn_RESNET50_8s_crfrnn(INPUT_SIZE,nb_classes,num_crf_iterations):
    ...
    # Fixing weighs in lower layers (optional)
    for layer in model.layers[:-1]:  # 15,21,29 (overall 30 layers) feezing until layer pred 8 (182)
        layer.trainable = False
...
def fcn_RESNET50_8s_crfrnnSP(INPUT_SIZE,nb_classes,num_crf_iterations):
    ...
    # Fixing weighs in lower layers (optional)
    for layer in model.layers[:-1]:  # feezing until layer pred 8 (182)
        layer.trainable = False
